...
public class  MsScanTSVWriter {
  ...
  private static String scan2String(ScanHeader scan, Integer runId) {
    ...
    String[] scanValues = {
    		...
    		String.valueOf(scan.getInitialId()),
    		String.valueOf(scan.getCycle()),
    		String.valueOf(scan.getTime()),
    		String.valueOf(scan.getMsLevel()),
    		String.valueOf(scan.getTIC()),
    		String.valueOf(scan.getBasePeakMz()),
    		String.valueOf(scan.getBasePeakIntensity()),
    		String.valueOf(scan.getPrecursorMz()),
    		String.valueOf(scan.getPrecursorCharge()),
    		"",//generate(LcmsScanProperties)
