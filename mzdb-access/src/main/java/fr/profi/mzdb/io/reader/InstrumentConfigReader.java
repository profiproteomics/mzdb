...
class InstrumentConfigReader {
  ...
  protected SQLiteConnection connection = null;
	...
	public InstrumentConfiguration getInstrumentConfig( int id ) throws SQLiteException {
	  ...
	  return new SQLiteQuery(connection, "select * from instrument_configuration where id = ?")
	                                    .bind(1, id)
      ...
      public InstrumentConfiguration extract(SQLiteRecord r) throws SQLiteException {
        ...
        return new InstrumentConfiguration( id, name, softwareId, ParamTreeParser.parseInstrumentConfigParamTree(paramTreeAsStr) );
      }
