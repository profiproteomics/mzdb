...
public interface IBlobReader {
	...
	/**
	 * 
	 * @param idx index of specified scan
	...
	/**
	 * 
	 * @param firstScanId needed in the constructor of the ScanSlice
	 * @param runSliceId needed in the constructor of the ScanSlice
