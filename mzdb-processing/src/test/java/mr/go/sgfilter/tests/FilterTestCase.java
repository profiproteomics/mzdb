...
public class FilterTestCase {
    ...
    public final void testComputeSGCoefficients() {
        double[] coeffs = SGFilterMath3.computeSGCoefficients(5,
                                                         5,
                                                         2);
        ...
        assertCoeffsEqual(coeffs,
                          tabularCoeffs);
        coeffs = SGFilterMath3.computeSGCoefficients(5,
                                                5,
                                                4);
        ...
        assertCoeffsEqual(coeffs,
                          tabularCoeffs);
        coeffs = SGFilterMath3.computeSGCoefficients(4,
                                                0,
                                                2);
    ...
    public final void testSmooth() {
        ...
        ContinuousPadder padder1 = new ContinuousPadder(false,
                                                        true);
        SGFilterMath3 sgFilter = new SGFilterMath3(5,
                                         5);
    ...
    public final void testSmoothWithBias() {
        double[] coeffs5_5 = SGFilterMath3.computeSGCoefficients(5,
                                                            5,
                                                            4);
        double[] coeffs5_4 = SGFilterMath3.computeSGCoefficients(5,
                                                            4,
                                                            4);
        double[] coeffs4_5 = SGFilterMath3.computeSGCoefficients(4,
                                                            5,
                                                            4);
